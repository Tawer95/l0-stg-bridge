...
fantom_rpc_url = 'https://endpoints.omniatech.io/v1/fantom/mainnet/public'
...
def swap_usdc_polygon_to_fantom(account, amount):
    address = polygon_w3.to_checksum_address(account.address)
...
def swap_usdc_fantom_to_polygon(account, amount):
    address = fantom_w3.to_checksum_address(account.address)
